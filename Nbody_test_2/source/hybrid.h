...
#define DIRECTORY ../data/S800L200_1000_rand1/  //ファイル保存用のディレクトリ
#define _STR(str) #str
...
#define INNER_AXIS 0.943  //トレーサーの長軸半径　下限
#define OUTER_AXIS 1.057  //トレーサーの長軸半径　上限
