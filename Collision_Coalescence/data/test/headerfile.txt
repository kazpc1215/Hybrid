...
//////////////////////////////////////////////////
#define PLANET_NO 1
#define PLANET_MASS 3.0E-6  //5.9723E27 [g] / 1.989E33 [g]
#define PLANET_RADIUS 4.0E-5  //6000 [km] / 1 [AU] 
...
//////////////////////////////////////////////////
#define T_MAX (2.0*M_PI*1.0E2)  //100yr  全計算時間
#define TIME_INTERVAL 2.0*M_PI*1.0E-6,2.0*M_PI*1.0E-5,2.0*M_PI*1.0E-4,2.0*M_PI*1.0E-3,2.0*M_PI*1.0E-2,2.0*M_PI*1.0E-1,2.0*M_PI*2.0E-1,2.0*M_PI*3.0E-1,2.0*M_PI*4.0E-1,2.0*M_PI*5.0E-1,2.0*M_PI*6.0E-1,2.0*M_PI*7.0E-1,2.0*M_PI*8.0E-1,2.0*M_PI*9.0E-1,2.0*M_PI*1.0E0,2.0*M_PI*1.1E0,2.0*M_PI*1.2E0,2.0*M_PI*1.3E0,2.0*M_PI*1.4E0,2.0*M_PI*1.5E0,2.0*M_PI*1.6E0,2.0*M_PI*1.7E0,2.0*M_PI*1.8E0,2.0*M_PI*1.9E0,2.0*M_PI*2.0E0,2.0*M_PI*1.0E1,2.0*M_PI*2.0E1,2.0*M_PI*3.0E1,2.0*M_PI*4.0E1,2.0*M_PI*5.0E1,2.0*M_PI*6.0E1,2.0*M_PI*7.0E1,2.0*M_PI*8.0E1,2.0*M_PI*9.0E1,T_MAX  //t_ene配列の中身
#define TIME_INTERVAL_MAX 35 //t_ene配列の要素数
//////////////////////////////////////////////////
