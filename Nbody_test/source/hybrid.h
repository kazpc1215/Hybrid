...
#define DIRECTORY ../data/1E24_0200_rand2/  //ファイル保存用のディレクトリ
#define _STR(str) #str
#define STR(str) _STR(str)

//#define N 10000  //粒子の数
#define N_tr 200  //トレーサーの数

#define M_TOT 1.0E-7  //2E26 g

#define RAND_SEED 2  //乱数の種

#define T_MAX (2.0*M_PI*1.0E3)  //1000yr  全計算時間

//#define TIME_INTERVAL 2.0*M_PI*1.0E1,2.0*M_PI*1.0E2,2.0*M_PI*1.0E3,2.0*M_PI*1.0E4,2.0*M_PI*1.0E5,2.0*M_PI*1.0E6,T_MAX  //t_ene配列の中身
//#define TIME_INTERVAL_MAX 7  //t_ene配列の要素数
...
#define INNER_AXIS 0.965  //トレーサーの長軸半径　下限
#define OUTER_AXIS 1.035  //トレーサーの長軸半径　上限
#define ECC_RMS 1.0E-4  //トレーサーの離心率の二乗平均平方根  //Rayleigh分布
#define INC_RMS 5.0E-5  //トレーサーの軌道傾斜角の二乗平均平方根  //Rayleigh分布




/*破壊用*/
#define DELTA_R 0.025  //近傍粒子探索用
#define DELTA_THETA 0.5*M_PI  //近傍粒子探索用
#define NEIGHBOR_MAX N_tr/2  //近傍粒子リスト配列の最大値
...
#define INTERACTION 1  //トレーサー間の相互作用
