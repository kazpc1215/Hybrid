...
#ifndef G
  return ((ele_p+j)->mass)*((v_0[j][k] - v_0[i][k])*rij3 - 3.0*r_dot_v_ij[j]*(x_0[j][k] - x_0[i][k])*rij5);
#else
  return G*((ele_p+j)->mass)*((v_0[j][k] - v_0[i][k])*rij3 - 3.0*r_dot_v_ij[j]*(x_0[j][k] - x_0[i][k])*rij5);
#endif
}
...
#ifndef G
  return -1.0*((ele_p+i)->mass)*x_0[i][k]*r3;
#else
  return -1.0*G*((ele_p+i)->mass)*x_0[i][k]*r3;
#endif
}
...
#ifndef G
  return -1.0*((ele_p+i)->mass)*(v_0[i][k]*r3 - 3.0*r_dot_v[i]*x_0[i][k]*r5);
#else
  return -1.0*G*((ele_p+i)->mass)*(v_0[i][k]*r3 - 3.0*r_dot_v[i]*x_0[i][k]*r5);
#endif
}
...
#if !defined(G) && !defined(M_0)
  return -1.0*(v_0[i][k]*r3 - 3.0*r_dot_v[i]*x_0[i][k]*r5);
#else
  return -1.0*G*M_0*(v_0[i][k]*r3 - 3.0*r_dot_v[i]*x_0[i][k]*r5);
#endif
}
