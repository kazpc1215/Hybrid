...
extern inline double InnerProduct(int i,const double x[][4],const double v[][4]);
extern inline double RadiusFromCenter(int i,const double x[][4]);
extern inline double SquareOfVelocity(int i,const double v[][4]);
extern inline double RelativeDistance(int i,int j,const double x[][4]);
extern inline double SquareOfRelativeVelocity(int i,int j,const double v[][4]);
...
int main(void){
  ...
  double abs_r[N_p+N_tr+1]={},r_dot_v_ij[N_p+N_tr+1]={},r_dot_v[N_p+N_tr+1]={};
