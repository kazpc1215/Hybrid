...
#define DIRECTORY ../data/Ejection_L2cone30equidistant_v1011curl_Frag_OnlyPlanet_xi001_n1000_100yr/  //ファイル保存用のディレクトリ.
...
//////////////////////////////////////////////////
#define T_MAX (2.0*M_PI*1.0E2)  //1E2yr  全計算時間.

#define DT_LOG 1  // 1: t_eneをlogでとる 0: t_eneをlinearでとる

/*  log 用 */
#define TIME_INTERVAL 2.0*M_PI*1.0E-6,2.0*M_PI*1.0E-5,2.0*M_PI*1.0E-4,2.0*M_PI*1.0E-3,2.0*M_PI*1.0E-2,2.0*M_PI*1.0E-1,2.0*M_PI*1.0E0,2.0*M_PI*1.0E1,T_MAX  //t_ene配列の中身.
