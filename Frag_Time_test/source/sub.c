...
double InnerProduct(int i,double x_0[][4],double v_0[][4]){
  ...
  clock_t end = clock();
  exetime.InnerProduct += (double)(end-start)/CLOCKS_PER_SEC;
}
...
double RadiusFromCenter(int i,double x_0[][4]){
  ...
  clock_t end = clock();
  exetime.RadiusFromCenter += (double)(end-start)/CLOCKS_PER_SEC;
}
...
double SquareOfVelocity(int i,double v_0[][4]){
  ...
  clock_t end = clock();
  exetime.SquareOfVelocity += (double)(end-start)/CLOCKS_PER_SEC;
}
...
double SquareOfRelativeDistance(int i,int j,double x_0[][4]){
  ...
  clock_t end = clock();
  exetime.SquareOfRelativeDistance += (double)(end-start)/CLOCKS_PER_SEC;
}
...
double SquareOfRelativeVelocity(int i,int j,double v_0[][4]){
  ...
  clock_t end = clock();
  exetime.SquareOfRelativeVelocity += (double)(end-start)/CLOCKS_PER_SEC;
}
...
double RelativeInnerProduct(int i,int j,double x_0[][4],double v_0[][4]){
  ...
  clock_t end = clock();
  exetime.RelativeInnerProduct += (double)(end-start)/CLOCKS_PER_SEC;
}
...
void Rotation_3D_xaxis(int i,double x_eject[][4],double theta){
  ...
  clock_t end = clock();
  exetime.Rotation_3D_xaxis += (double)(end-start)/CLOCKS_PER_SEC;
}
...
void Rotation_3D_yaxis(int i,double x_eject[][4],double theta){
  ...
  clock_t end = clock();
  exetime.Rotation_3D_yaxis += (double)(end-start)/CLOCKS_PER_SEC;
}
...
void Rotation_3D_zaxis(int i,double x_eject[][4],double theta){
  ...
  clock_t end = clock();
  exetime.Rotation_3D_zaxis += (double)(end-start)/CLOCKS_PER_SEC;
}
...
void Swap(double *a, double *b){
  ...
  clock_t end = clock();
  exetime.Swap += (double)(end-start)/CLOCKS_PER_SEC;
}
...
void CenterOfGravity(double x_0[][4],double v_0[][4],double x_G[],double v_G[],struct orbital_elements ele[]){
  ...
  clock_t end = clock();
  exetime.CenterOfGravity += (double)(end-start)/CLOCKS_PER_SEC;
}
