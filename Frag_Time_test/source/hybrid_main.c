...
int main(void){
  ...
  */
  ...
  printf("\nexecution time\n");
  printf("AngularMomentum = %e [s]\n",exetime.AngularMomentum);
  printf("InnerProduct = %e [s]\n",exetime.InnerProduct);
  printf("RadiusFromCenter = %e [s]\n",exetime.RadiusFromCenter);
  printf("SquareOfVelocity = %e [s]\n",exetime.SquareOfVelocity);
  printf("Timestep_i_0 = %e [s]\n",exetime.Timestep_i_0);
  printf("Timestep_i_sys = %e [s]\n",exetime.Timestep_i_sys);
  printf("SquareOfRelativeDistance = %e [s]\n",exetime.SquareOfRelativeDistance);
  printf("SquareOfRelativeVelocity = %e [s]\n",exetime.SquareOfRelativeVelocity);
  printf("RelativeInnerProduct = %e [s]\n",exetime.RelativeInnerProduct);
  printf("Acceleration_ij = %e [s]\n",exetime.Acceleration_ij);
  printf("dAcceleration_ij = %e [s]\n",exetime.dAcceleration_ij);
  printf("Acceleration_indirect = %e [s]\n",exetime.Acceleration_indirect);
  printf("dAcceleration_indirect = %e [s]\n",exetime.dAcceleration_indirect);
  printf("External_Acceleration = %e [s]\n",exetime.External_Acceleration);
  printf("External_dAcceleration = %e [s]\n",exetime.External_dAcceleration);
  printf("All_Acceleration = %e [s]\n",exetime.All_Acceleration);
  printf("All_dAcceleration = %e [s]\n",exetime.All_dAcceleration);
  printf("Calculate_OrbitalElements = %e [s]\n",exetime.Calculate_OrbitalElements);
  printf("Calculate_P = %e [s]\n",exetime.Calculate_P);
  printf("Calculate_Q = %e [s]\n",exetime.Calculate_Q);
  printf("Calculate_Energy = %e [s]\n",exetime.Calculate_Energy);
  printf("InitialCondition = %e [s]\n",exetime.InitialCondition);
  printf("Predictor = %e [s]\n",exetime.Predictor);
  printf("Corrector_sys = %e [s]\n",exetime.Corrector_sys);
  printf("Iteration_sys = %e [s]\n",exetime.Iteration_sys);
  printf("Collision_Judgement = %e [s]\n",exetime.Collision_Judgement);
  printf("Energy_Correction = %e [s]\n",exetime.Energy_Correction);
  printf("Coalescence = %e [s]\n",exetime.Coalescence);
  printf("NeighborSearch = %e [s]\n",exetime.NeighborSearch);
  printf("RandomVelocity = %e [s]\n",exetime.RandomVelocity);
  printf("MassFlux = %e [s]\n",exetime.MassFlux);
  printf("Depletion_Time = %e [s]\n",exetime.Depletion_Time);
  printf("MassDepletion = %e [s]\n",exetime.MassDepletion);
  printf("s_1_FRAG_trapezoid = %e [s]\n",exetime.s_1_FRAG_trapezoid);
  printf("s_2_FRAG_trapezoid = %e [s]\n",exetime.s_2_FRAG_trapezoid);
  printf("s_3_FRAG_trapezoid = %e [s]\n",exetime.AngularMomentum);
  printf("s_1_FRAG_integrand = %e [s]\n",exetime.s_1_FRAG_integrand);
  printf("s_2_FRAG_integrand = %e [s]\n",exetime.s_2_FRAG_integrand);
  printf("s_3_FRAG_integrand = %e [s]\n",exetime.s_3_FRAG_integrand);
  printf("s_1_FRAG = %e [s]\n",exetime.s_1_FRAG);
  printf("s_2_FRAG = %e [s]\n",exetime.s_2_FRAG);
  printf("s_3_FRAG = %e [s]\n",exetime.s_3_FRAG);
  printf("Rotation_3D_xaxis = %e [s]\n",exetime.Rotation_3D_xaxis);
  printf("Rotation_3D_yaxis = %e [s]\n",exetime.Rotation_3D_yaxis);
  printf("Rotation_3D_zaxis = %e [s]\n",exetime.Rotation_3D_zaxis);
  printf("Swap = %e [s]\n",exetime.Swap);
  printf("CenterOfGravity = %e [s]\n",exetime.CenterOfGravity);
