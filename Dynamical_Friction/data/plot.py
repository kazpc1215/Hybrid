...
for T in range(0, LINE):
    ...
    plt.tight_layout()
    filename = "../image/Ntr1E3_t1E4yr_dt1yr_Mtot3E-5_ecc1E-1_inc5E-2_rand4/axis_ecc_T%05.0fyr.png" % time[1, T]
    plt.grid(True)
    ...
    plt.legend(loc="upper left", fontsize=15)
    plt.tight_layout()
    filename = "../image/Ntr1E3_t1E4yr_dt1yr_Mtot3E-5_ecc1E-1_inc5E-2_rand4/axis_inc_T%05.0fyr.png" % time[1, T]
    plt.grid(True)
    plt.savefig(filename)
    plt.close()
