...
#define DIRECTORY ../data/NoFrag_Ntr0090/  //ファイル保存用のディレクトリ
#define _STR(str) #str
#define STR(str) _STR(str)

//#define N 10000  //粒子の数
#define N_tr 90  //トレーサーの数

#define RAND_SEED 1  //乱数の種

#define T_MAX (2.0*M_PI*1.0E3)  //1kyr  全計算時間

#define TIME_INTERVAL 2.0*M_PI*1.0E1,2.0*M_PI*1.0E2,T_MAX  //t_ene配列の中身
...
//#define M_TOT 4.96E-4  //9.92E29 g

#define M_tr 5.0E-10  //1E24g
#define M_TOT M_tr*N_tr
