...
#define DIRECTORY ../data/deltar_10Hill/  //ファイル保存用のディレクトリ
#define _STR(str) #str
#define STR(str) _STR(str)

//#define N 10000  //粒子の数
#define N_tr 100  //トレーサーの数

#define RAND_SEED 1  //乱数の種

//#define DELTA_R 0.025  //近傍粒子探索用  //定義しないときは初期の質量で計算した DELTA_HILL hill半径
#define DELTA_HILL 10.0

#define DELTA_THETA 0.5*M_PI  //近傍粒子探索用

#define T_MAX (2.0*M_PI*1.0E5)  //100kyr  全計算時間

#define TIME_INTERVAL 2.0*M_PI*1.0E1,2.0*M_PI*1.0E2,2.0*M_PI*1.0E3,2.0*M_PI*1.0E4,T_MAX  //t_ene配列の中身
