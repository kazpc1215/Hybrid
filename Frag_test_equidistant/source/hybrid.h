...
#define DIRECTORY ../data/deltar_0010au_0990_xi0005_cutting_edge_2/  //ファイル保存用のディレクトリ
#define _STR(str) #str
#define STR(str) _STR(str)

//#define N 10000  //粒子の数
//#define N_tr 1000  //トレーサーの数
#define N_tr 990  //トレーサーの数
...
#define P_FRAG 0.453
#define XI 0.005 //統計的計算のタイムステップがタイムスケールの"XI"倍
//#define M_MAX 5.00E-15  //微惑星質量　1E19 g
#define M_MAX 5.028E-16  //微惑星質量　1E18 g
//#define M_TOT 4.994E-4  //9.933E29 g
#define M_TOT 0.0017664   //3.5134E30 g, e=0.001, i=0.0005 ,v_ave=0.001486 [AU/(yr/2pi)] 
