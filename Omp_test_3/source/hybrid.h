...
#define DIRECTORY ../data/Ntr1E4_t1E0yr_all_omp01/  //ファイル保存用のディレクトリ.
...
#define ORBITALELEMENTS_FILE false  //軌道要素計算&ファイル作成.
#define POSI_VELO_FILE false  //位置速度ファイル作成.
#define POSI_VELO_ROT_FILE false  //回転座標系の位置速度ファイル作成.
#define COLLISION_FILE false  //衝突直前の位置速度ファイル作成.
...
#if N_tr != 0
//////////////////////////////////////////////////
#define M_TOT (3.0E-6)  //1M_E  //トレーサーの総質量.
...
//////////////////////////////////////////////////
#define T_MAX (2.0*M_PI*1.0E0)  //1yr 全計算時間.
