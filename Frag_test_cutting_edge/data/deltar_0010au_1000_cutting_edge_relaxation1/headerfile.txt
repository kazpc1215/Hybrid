//円盤を4分割、軌道長半径は等間隔
//粒子が絶対に存在しない範囲を探索しないように、delta_r_outとdelta_r_inを定義
//面密度が初期で一様となってほしいため、面密度が一様となる100年後の軌道要素を読み込んで代入
//2は面密度に応じて質量をいじらない 1はいじる
//とりあえず10回Relaxation
...
#define DIRECTORY ../data/deltar_0010au_1000_cutting_edge_relaxation1/  //ファイル保存用のディレクトリ
#define _STR(str) #str
...
#define TIME_INTERVAL 2.0*M_PI*1.0E1,T_MAX  //t_ene配列の中身
#define TIME_INTERVAL_MAX 2  //t_ene配列の要素数
